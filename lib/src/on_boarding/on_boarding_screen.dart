...
import 'package:parko/core/common/widgets/custom_continue_button.dart';
import 'package:parko/core/utils/move_screen.dart';
import 'package:parko/src/auth/login_screen.dart';
      ...
      body: SafeArea(
        child: SingleChildScrollView(
          child: Column(
            children: [
              const Image(
                image: AssetImage('assets/images/car_clipart.png'),
              ),
              Center(
                child: Text(
                  'Welcome to\nParko!',
